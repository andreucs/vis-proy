...
```{r}
rank <- read_csv("data/turismo_provincias_rank_bump.csv")
rank
```
...
rank_top_5 <- rank |>
              ...
              mutate(Prov=as.factor(Province)) |>
              mutate(hover_info = paste("Año:", Year, "<br>Posición:", Position, "<br>Provincia:", "32553"))
