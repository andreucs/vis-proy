...
ocup1 <- read_csv("data/ocupacion.csv")
...
### containerAnimated {width="60%"}
```{r}
plotlyOutput("animated")
```


### containerLoli {width="40%"}
```{r}
...
render_animated_bubble(output, input, ocup1, color_residentes = colores$color5, color_extranjeros = colores$color9)

render_lollipop(output, input, ocup1, ccaa)
```
