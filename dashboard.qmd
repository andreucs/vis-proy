...
list(
  title="Fin del estado de alarma",
  color = "primary",
  value = "Junio 2020"
...
list(
  title="Fin de la crisis sanitaria",
  color = "primary",
  value = "Julio 2023"
...
list(
  title = "Pernoctaciones menos en 2020 vs predicción",
  color = "primary",
  value = "61 M"
...
list(
  title="Con peores valores de los predichos", 
  color = "primary",
  value = "3 años"
